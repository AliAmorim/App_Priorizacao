# 1458a71b-01a4-4767-8b10-6e9993dc6f4c implementation handoff

This archive is the source of truth for turning the design into production code. Start from `priorizacao-devops.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- Script/component files detected: 8
...
- A single self-contained `priorizacao-devops.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `priorizacao-devops.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `guia-banco-supabase-passo-a-passo.md`
- `id-t-tulo-8-_1_.csv`
- `id-t-tulo-8.csv`
- `image.png`
- `Itens-para-priorizar.csv`
- `package.json`
- `README.md`
- `schema.sql`
- `vercel.json`
...
1. Inspect `priorizacao-devops.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
